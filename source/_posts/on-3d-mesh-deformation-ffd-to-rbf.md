...
![09874f19ca6adb84f9552fdf3c1ec90e.png](/images/09874f19ca6adb84f9552fdf3c1ec90e.png)

其中，![1880c40096a8c2a8d16f9072bf5af7b2.png](/images/1880c40096a8c2a8d16f9072bf5af7b2.png)

是其中一个晶格的控制点。而Ni是一个B样条线的基函数。

上面式子中的u,v,w是某个模型顶点在控制晶格中的局部坐标，即原论文中的s,t,u

![2feb0b8d67dba61bca0db73034fa5758.png](/images/2feb0b8d67dba61bca0db73034fa5758.png)

在原始论文中表述为

![27c7bf846d22e0d97d6ae062c7d83f51.png](/images/27c7bf846d22e0d97d6ae062c7d83f51.png)
...
![c05d52e069e1a5d9375544dc619acfe7.png](/images/c05d52e069e1a5d9375544dc619acfe7.png)

其表述与经典FFD基本一致。权重仍然只与位置相关。只不过，这里控制点的权重不是用B样条基函数计算的，而被称为广义重心坐标(generalized barycentric coordinates).

![cde8ba37859c6329baae9f290fa7eec4.png](/images/cde8ba37859c6329baae9f290fa7eec4.png)
...
![31a7f2be12c5f35674c39526af81cc4e.png](/images/31a7f2be12c5f35674c39526af81cc4e.png)
...
![438e6a838bd3480fc62b834ca67aaa7b.png](/images/438e6a838bd3480fc62b834ca67aaa7b.png)

其中，Mc,c是控制点相互的基函数

![90fe7218fbc07798411c566ce302339f.png](/images/90fe7218fbc07798411c566ce302339f.png)
...
![3d5041b9f605dc354f2bb3d7cc8a92e2.png](/images/3d5041b9f605dc354f2bb3d7cc8a92e2.png)

1. Houdini中的实现

由于需要解一个线性方程，可以用numpy.linalg来做，这里写了一个python节点，其实也只需要一个python节点

![959a6768fd563561a57578834951bb30.png](/images/959a6768fd563561a57578834951bb30.png)
...
![6d6a36f10e72423914d10235c97bc777.png](/images/6d6a36f10e72423914d10235c97bc777.png)
...
![deform_person_node.PNG](/images/deform_person_node.PNG)
