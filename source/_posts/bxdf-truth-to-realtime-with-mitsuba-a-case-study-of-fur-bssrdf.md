...
![measure_brdf.png](/images/measure_brdf.png)
...
![hair-terms.png](/images/hair-terms.png)
...
![azimuthd.png](/images/azimuthd.png)
...
![doublecylinder.png](/images/doublecylinder.png)
...
![hair-mitsuba.png](/images/hair-mitsuba.png)
...
![hairvsfur.png](/images/hairvsfur.png)
...
![cm-approx.png](/images/cm-approx.png)
...
![fur-simp.png](/images/fur-simp.png)

对比一下不同路径项与离线渲染的区别。 如我们预测的，颜色项有一定区别。TTs和TRTs中由于固定h计算的吸收颜色有些接近，但不正确

TRT和TT中分布也有些误差

![mitsuba-vs-unity.png](/images/mitsuba-vs-unity.png)
...
![haircards-and-shell.png](/images/haircards-and-shell.png)
...
![uescatter.png](/images/uescatter.png)

Frosbite的做法相对精确一些，用Deep Opacity Map

![frosbite-multiscatter.png](/images/frosbite-multiscatter.png)

我们这里抄一下UE的做法

不是，这也太假了吧。。。。

![hack-multiscatter.png](/images/hack-multiscatter.png)
